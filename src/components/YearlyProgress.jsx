 ...
 * Uses motion system for coordinated bar chart animations
 */
const YearlyProgress = memo(({ habitList }) => {
  ...
  return (
    <div ref={containerRef} style={{ opacity: 0 }} className="card p-5 sm:p-6">
            ...
            <div key={i} className="flex-1 flex flex-col items-center">
              ...
              <div className="w-full h-32 flex items-end justify-center relative group">
                <div
                  ...
                  `}
                  style={{ 
                    height: isFutureMonth ? '10%' : `${Math.max(height, 5)}%`,
                    transform: 'scaleY(0)',
                    transformOrigin: 'bottom'
                  }}
                />
                ...
                {!isFutureMonth && (
                  <div className="
                    ...
                    bg-dark-600 px-2 py-1 rounded text-xs text-white
              ...
              <span 
                ...
                className={`
                  ...
                  ${isCurrentMonth ? 'text-accent-primary font-medium' : 'text-white/40'}
                `}
              >
      ...
      {/* Summary stats */}
      <div ref={summaryRef} style={{ opacity: 0 }} className="mt-6 pt-4 border-t border-white/5 grid grid-cols-2 gap-4">
